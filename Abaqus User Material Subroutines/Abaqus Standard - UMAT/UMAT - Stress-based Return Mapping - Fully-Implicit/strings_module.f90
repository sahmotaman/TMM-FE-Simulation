...
! Reference: http://www.gbenthien.net/strings/index.html
!=======================================================================
...
use controls, only: pReal, pInt

private :: value_r,  value_i
private :: write_r,  write_i
private :: writeq_r, writeq_i
...
interface value  ! Generic operator for converting a number string to a 
   ...
   module procedure value_r
   module procedure value_i
end interface
...
interface writeq  ! Generic interface equating a name to a numerical value. The
   ...
   module procedure writeq_r
   module procedure writeq_i
end interface
...
subroutine value_r(str,rnum,ios)
...
end subroutine value_r

!**********************************************************************

subroutine value_i(str,inum,ios)

! Converts number string to an integer value

character(len=*)::str
integer(pInt) :: inum
real(pReal) :: rnum

call value_r(str,rnum,ios)
...
subroutine write_r(rnum,str,fmt)
...
subroutine write_i(inum,str,fmt)
...
subroutine writeq_r(unit,namestr,value,fmt)
...
end subroutine writeq_r

!**********************************************************************

subroutine writeq_i(unit,namestr,ivalue,fmt)
