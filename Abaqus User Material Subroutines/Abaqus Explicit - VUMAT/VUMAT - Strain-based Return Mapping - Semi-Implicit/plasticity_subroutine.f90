...
!    calculation of temperature-dependent product of shear modulus and interaction strength   {Eq. 93(c)}
...
!     calculation of plastic/critical stress
     ...
     sigma_p  = sigma_pc + sigma_pw   ! {Eq. 92(b)}

!    calculation of plastic tangent modulus   {Eq. 108}
